...
if __name__ == "__main__":
    ...
    # insert data from text file and remove newlines from input
    engWords = open('words_alpha.txt', 'r').read().splitlines()
    ...
    # counter for same words
    count = 0
    for line in finWords:
        if HT.search(line) is True:
            count += 1
    
    # print total number of same words
    print()
    print(str(count) + " words found from hash table")
